...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withCcaInformations(Set.of(new CcaInformation(BASKETBALL, Optional.of(CAPTAIN),
                    BASKETBALL.createNewAttendance()))).build();
    ...
    public static AddressBook getTypicalAddressBook() {
        ...
        ObservableList<Cca> uniqueCcaList = ab.getCcaList();

        for (Person person : getTypicalPersons(uniqueCcaList)) {
            ab.addPerson(person);
        }
        return ab;
    }

    public static List<Person> getTypicalPersons(ObservableList<Cca> uniquePersonList) {
