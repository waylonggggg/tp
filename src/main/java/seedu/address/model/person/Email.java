...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain "
            ...
            + "1. The entire email must not exceed 150 characters (including the '@' and domain).\n"
    ...
    public static final String VALIDATION_REGEX = "^(?=.{1,150}$)" + LOCAL_PART_REGEX + "@" + DOMAIN_REGEX;
